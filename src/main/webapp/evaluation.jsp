...
<div class="x-body">
    <xblock><button class="layui-btn layui-btn-normal" onclick="findAllScore()"><i class="layui-icon">&#xe666;</i>点击刷新</button><span class="x-right" style="line-height:40px"></span></xblock>
